...
class GreenBook:
    def __init__(self,x = 640, y = 360, level=1):
        ...
        self.attack_image = load_image('resource/mob/greenbook/greenbook_attack.png')
        self.attack_end_image = load_image('resource/mob/greenbook/greenbook_attackend.png')
        self.death_image = load_image('resource/mob/greenbook/greenbook_death.png')
        self.hit_image = load_image('resource/mob/greenbook/greenbook_hit.png')
