...
attack_animation = (
(0,0,27,39), (31,0,25,37), (65,0,32,39), (96,0,32,39), (132,0,32,39)
)
charge_attack_animation = (
(0,0,22,39), (26,0,22,38), (52, 0, 22, 37), (78,0,22,37)
)
walk_animation = (
    ((0,44,22,39), (26,44,28,40), (58,44,27,36), (89,44,22,39), (115,44,28,40), (147,44,28,38)), # 오른쪽 아래
    ((0,0,22,39), (26,0,28,40), (61,0,27,36), (92,0,25,39), (121,0,28,40), (153,0,28,38)),       # 오른쪽 위
)
...
class Smilely:
    def __init__(self, x=640, y=360, level=1):
        ...
        self.idle_image = load_image('resource/mob/smilely/smilely_idle.png')
        self.attack_image = load_image('resource/mob/smilely/smilely_attack.png')
        self.charge_attack_image = load_image('resource/mob/smilely/smilely_charge_attack.png')
        self.death_image = load_image('resource/mob/smilely/smilely_death.png')
        self.hit_image = load_image('resource/mob/smilely/smilely_hit.png')
        self.walk_image = load_image('resource/mob/smilely/smilely_walk.png')
